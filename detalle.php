...
//var_dump($producto_array_fotos);die;
...
<div id='container'>
  <div id="content-container" >
    <div id='maincontent' >
      ...
      <div class="row">
        <div class="col-md-12">
          <h4><?php echo $producto_titulo;?> </h4>
        </div>
      </div>
  <p id='info'>Las fotos son tal cual como es el producto. </p>
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-3">
        <?php
            $primer_foto = $producto_array_fotos[0];
            //var_dump($producto_array_fotos);die;

            //$fileName_xs = substr($fileName, 0, strlen($fileName)-4).'_xs'.substr($fileName, strlen($fileName)-4,4);
            $fileName_md = substr($primer_foto, 0, strlen($primer_foto)-4).'_md'.substr($primer_foto, strlen($primer_foto)-4,4);
            $fileName_lg = substr($primer_foto, 0, strlen($primer_foto)-4).'_lg'.substr($primer_foto, strlen($primer_foto)-4,4);

         ?>
        <div class="zoom-small-image">
          <a href='images/zoomengine/<?php echo $fileName_lg;?>' class = 'cloud-zoom' id='zoom1' rel="adjustX: 10, adjustY:-4"><img src="images/<?php echo $fileName_md;?>" alt='' title="" /></a></div>
      </div>
      <div class="col-xs-12 col-sm-9 text-center">
        <div class="zoom-desc">
          <p>
            <?php
                 $i=0;
                 foreach ($producto_array_fotos as $value) {
                   $i++;
                   $fileName_xs = substr($value, 0, strlen($value)-4).'_xs'.substr($value, strlen($value)-4,4);
                   $fileName_md = substr($value, 0, strlen($value)-4).'_md'.substr($value, strlen($value)-4,4);
                   $fileName_lg = substr($value, 0, strlen($value)-4).'_lg'.substr($value, strlen($value)-4,4);
                   //if ($i==1) die($fileName_md);
                   ?>
                    <a href='images/zoomengine/<?php echo $fileName_lg;?>' class='cloud-zoom-gallery' title='Red' rel="useZoom: 'zoom1', smallImage: 'images/zoomengine/<?php echo $fileName_md;?> ' "><img class="zoom-tiny-image" src="images/<?php echo $fileName_xs; ?> " alt = "Thumbnail 1" class="zoom-tiny-image"/></a>
            <?php
                 }
             ?>
            ...
            <a href='images/zoomengine/bigimage02.jpg' class='cloud-zoom-gallery' title='Blue' rel="useZoom: 'zoom1', smallImage: 'images/zoomengine/smallimage-2.jpg' "><img src="images/tinyimai.jpg" alt = "Thumbnail 3" border="0" class="zoom-tiny-image"/></a> -->
          </p>
          <table>
            <tr>
