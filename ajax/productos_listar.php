...
if ($categoria==99) $categoria='%';
if($action == 'ajax'){
	//$query = mysqli_real_escape_string($con,(strip_tags($_REQUEST['query'], ENT_QUOTES)));
  $query=$_REQUEST['query'];
	$tables="articulos";
	$campos="*";
	$sWhere="  articulos.idOnce not like 'c-%' and (articulos.descripcion LIKE '%".$query.
	        "%' or articulos.idOnce LIKE '%".$query."%' or articulos.codigoBarra LIKE '%".$query."%') ".
					" and categoria_id like '".$categoria."'";
			...
			<table class="table table-striped table-hover table-bordered table-wrapper">
				<thead>
					<tr>
						...
						<th style="color: black !important;" width='55%'>PRODUCTO </th>
				...
				<tbody>
						...
						<tr style="font-family: "Lato", "Helvetica Neue", Helvetica, Arial, sans-serif;font-size: 13px;">
							...
							<td class="small" style="color: black;"><a href="detalle.php?id=<?php echo $row["id"]; ?>"><?php echo $prod_name_patron;?></a></td>
