...
$sql=mysqli_query($db,"select * from promociones where id='$id_banner' limit 0,1");
...
<ol class="breadcrumb">
        ...
        <li><a href="../index.php" target="_blank"><i class='glyphicon glyphicon-blackboard'></i> Ver Sitio</a></li>
		 ...
		 <div class="col-md-7">
		 <h3 ><span class="glyphicon glyphicon-edit"></span> Editar Articulo</h3>
     <form class="form-horizontal" id="editar_banner">
       ...
       <div class="form-group">
       <label for="orden" class="col-sm-3 control-label">Recargo</label>
       <div class="col-sm-9">
         <input type="text" class="form-control" id="recargo" name="recargo" value="<?php echo $recargo;?>">
       </div>
       </div>
				...
				<div class="col-sm-12">
				 <div class="fileinput fileinput-new" data-provides="fileinput">
								  ...
								  <div>
    									...
    									<span class="fileinput-exists" onclick="upload_image();">Cambiar imagen</span>
    									   <input type="file" name="fileToUpload" id="fileToUpload" required onchange="upload_image();"></span>
