          ...
          <div id="custom-search-input">
            <div class="input-group col-md-12">
              <span class="input-group-btn">
                <a href='#' data-target="#uploadArchivoModal" data-toggle="modal" class="btn btn-info" type="button">
                  <img src="img/importar1.png" alt="">
                </a>
              </span>
            </div>
          </div>
...
<!-- Edit Modal HTML -->
<?php include("html/modal_upload.php");?>
